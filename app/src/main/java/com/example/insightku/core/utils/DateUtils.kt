...
object DateUtils {
    ...
    fun formatDate(timestamp: Long, pattern: String = AppConstants.DATE_FORMAT_DISPLAY): String {
        val sdf = SimpleDateFormat(pattern, Locale.getDefault())
        return sdf.format(Date(timestamp))
    }

    fun formatTime(timestamp: Long): String {
        val sdf = SimpleDateFormat(AppConstants.TIME_FORMAT_DISPLAY, Locale.getDefault())
        return sdf.format(Date(timestamp))
    }

    fun formatDateTime(timestamp: Long): String {
        val sdf = SimpleDateFormat(AppConstants.DATETIME_FORMAT_DISPLAY, Locale.getDefault())
        return sdf.format(Date(timestamp))
    }
